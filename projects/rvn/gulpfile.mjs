...
function css() {
	return gulp.src(["./src/assets/style/**/*.scss", "!./src/assets/style/**/_*.scss"])
		...
		.pipe(destGulp.dest("../../src/assets/static/rvn/assets/style/"))
		.pipe(bs.stream())
}
...
function js() {
	return gulp.src(["./src/assets/script/**/*.js", "!./src/assets/script/**/_*.js"])
		...
		.pipe(replaceSrc())
		.pipe(sourcemaps.write("./"))
		.pipe(destGulp.dest("../../src/assets/static/rvn/assets/script/"))
		.pipe(bs.stream())
}
...
function html() {
	return gulp.src(["./src/*.ejs", "./src/*.html"])
		...
		.pipe(replaceSrc())
		.pipe(destGulp.dest("../../src/assets/static/rvn"))
		.pipe(bs.stream())
}
...
function copyStatic() {
	return gulp.src(["./src/assets/static/**/*", "!./src/assets/static/img-raw/**/*"], {
		...
		.pipe(destGulp.dest("../../src/assets/static/rvn/assets/static/"))
		.pipe(reload())
}
